...
4. **Зарегистрированный пользователь входит в группу**
   ...
   5. Пользователь регистрируется в этой группе, роль пользователя меняется на *рядовой студент* относительно этой группы
   ...
   1. Пользователь перенаправляется на страницу группы
   
   4а. Пользователь уже зарегистрирован в другой группе
   
   1. Пользователь перенаправлен на страницу, сообщающей пользователю, что он не может быть зарегистрирован одновременно в более, чем одной группе
...
5. **Пользователь просматривает информацию другого пользователя**
  ...
  1. Пользователь перенаправлен на страницу, сообщающей пользователю, что просматриваемый пользователь не существует
...
6. **Пользователь покидает группу**
  ...
  1. Пользователь покидает группу, более не числится в участниках данной группы и получает роль *зарегистрированного пользователя*
  
  Расширения
  
  1а. Пользователь был выкинут из группы другим пользователем группы с рангом выше, чем этот пользователь. Выкинутый из группы пользователь более не числится в участниках данной группы и получает роль *зарегистрированного пользователя*
...
9. **Удаление группы**
  ...
  2. Все сущности связанные с группой (за исключением сущности *пользователь*) более недоступны (и удаляются, наверн)
  3. Все участники группы получают роль *зарегистрированного пользователя* и более не связаны с данной группой
