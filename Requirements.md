...
* Возможный пользователь впервые зашёл на сайт
  * Пользователь считается гостем и обладает его возможностями
* Возможный пользователь авторизуется
  * Пользователь считается авторизованным
  * Провайдер авторизации сохраняется вместе с необходимы данными
  * Пользователю предлагается заполнить информацию о нём:
    * ФИО
    * Учебное заведение
    * Группа
  * При успешном заполнении данных пользователю присваивается выбранный статус
