...
6. **Пользователь покидает группу**
  ...
  1. Выкинутый из группы пользователь более не числится в участниках данной группы
  
  2. Выкинутый пользователь получает роль *зарегистрированного пользователя*
