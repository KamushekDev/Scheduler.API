...
7. **Изменение уровня доступа группы**
   ...
   5. Следующие сущности группы меняют свой уровень видимости: //я запуталсо, в теории списки остаются пабликами, но содержимое списков всё ещё групповые/унаследованные
