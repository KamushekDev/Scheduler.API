...
6. **Пользователь покидает группу**
  ...
  1а. Пользователь был выкинут.
  
  1. Пользователь был выкинут из группы другим пользователем группы с рангом выше, чем этот пользователь. 
  
  2. Выкинутый из группы пользователь более не числится в участниках данной группы
  
  3. Выкинутый пользователь получает роль *зарегистрированного пользователя*
